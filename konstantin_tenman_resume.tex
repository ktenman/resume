...
%--------PROFILE------------
\section{Profile}{Self-motivated Software Developer with six years of experience including over
four years of experience in Java development. I would like to participate in true teamwork and
develop well-tested applications using a continuous delivery approach. I enjoy doing deep investigations,
learning new technologies, and always looking for ways to do
things better.}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Pricing}
        {Researched regarding breaking monolithic application into single responsibility micro-services. Refactored and
...
%\resumeItemListStart
  ...
  \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItemWithoutTitle{}
          {Developed a full-stack web-based application where users create services and search for them 
          through Google Maps.}
